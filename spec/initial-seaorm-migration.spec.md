...
ISM4.12n. Migration `m20260901_000049_request_logs_pending_status_index` MUST create the request-log partial index defined by `request-logs.spec.md` RL-S13. It MUST run after the model-pricing cutover.
