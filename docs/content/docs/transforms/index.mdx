...
| Field | Set, remove, or cap raw request/response fields | `field_alias_reserved_tool_names`, `field_custom_tools_to_function`, `field_override_max_tokens`, `field_remove`, `field_set` |
