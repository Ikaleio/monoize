...
Type text in the search box above the list. The list shows only the keys whose name or key prefix contains that text. **Select all** selects only the keys that the list shows.
